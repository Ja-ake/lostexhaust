...
public class Timestamp {
    ...
    /**
     * Calculates the difference between two Timestamps by subtracting
     * this Timestamp from the parameter given.
     */
    ...
    /**
     * Checks if a Timestamp is still valid. Calculated with 
